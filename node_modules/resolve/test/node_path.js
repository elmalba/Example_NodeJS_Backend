...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/iniciar.js'));
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/iniciar.js'));
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/iniciar.js'));
    });
